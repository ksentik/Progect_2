class BSTNode:
    ...
    def __init__(self, category, amount):
        """
        Создаёт новый узел дерева с категорией и суммой
        """
...
class BudgetTree:
    ...
    def insert(self, category, amount):
        ...
        Если категория уже существует, то прибавляет сумму к существующей
        """
    ...
    def find(self, category):
        ...
        Возвращает BSTNode или None если категория не найдена
        """
    ...
    def inorder_traversal(self):
        ...
        Возвращает список кортежей (category, total) в алфавитном порядке
        """
        result = []
