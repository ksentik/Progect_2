...
def get_sum_for_period(prefix, day_a, day_b):
    ...
    Возвращает сумму расходов за период, или None если дни некорректны
    """
...
def find_max_expense_day(expenses):
    ...
    Возвращает (день, сумма) или (None, 0) если расходов нет
    """
    if not expenses:
        return None, 0
...
def get_categories_sorted(expenses):
    ...
    Возвращает список кортежей (category, total) отсортированный по убыванию суммы
    """
    if not expenses:
        return []
